  ...
  return (
    <div className="border-t bg-accent/5 p-6 sm:p-8">
      <div className="mb-4 text-center">
        <EditableText
          contentKey="result_title"
          defaultContent="Annual CO₂ Emissions"
          className="mb-1 text-sm font-medium uppercase tracking-wide text-muted-foreground"
          as="div"
          isAdmin={isAdmin}
        />
        ...
        <EditableText
          contentKey="result_unit"
          defaultContent="tons per year"
          className="mt-1 text-xl font-medium text-muted-foreground"
          as="div"
          isAdmin={isAdmin}
        />
      </div>
